...
import { Button,Navbar,NavDropdown,Nav, ButtonGroup, Dropdown, Badge } from "react-bootstrap";
...
const Header = (props) => {
  ...
  const currentPosition=()=>{
    ...
    if (navigator.geolocation) {
      ...
      setAddress("Get Your Current Address");
    }
  }
  useEffect(() => {
    if (isSignUp) {
      ...
      <div className="mobile-show">
        ...
        <div className="container">
          ...
          <Navbar collapseOnSelect expand="lg" bg="light" variant="dark">
            <Navbar.Brand
              className="flex-grow-1 d-flex justify-content-between m-0"
              ...
              <div className="mobile-icon">
                ...
                <Dropdown as={ButtonGroup} title="Dropdown ">
                  <Dropdown.Toggle id="dropdown-custom-1">
                    <span class="badge badge-light">{notiCount.total}</span>
            ...
            <Navbar.Toggle
              className="bg-success nav-sizings"
              ...
              <Nav className="mr-auto mobile-nav">
                <Nav.Link  href="#features">
                  ...
                  <Link to="/offers" className="header-bottom-btn">
                    <img className="mr-4" style={{width:"30px"}} src={offerIcon} />
          ...
          <div className="col-md-2 col-sm-3  col-12">
            ...
            <div className="col-md-10 col-sm-9 col-12">
              <div className="top-right">
                <Search show={searchShow} className=" search" closed={searchClose} />
                <div className="notification-btn">
                  <Dropdown as={ButtonGroup} title="Dropdown ">
                    <Dropdown.Toggle id="dropdown-custom-1" className="custom-dropdown">
                      <span class="badge badge-light">{notiCount.total}</span>
                      <span className="sr-only">unread messages</span>
                ...
                <div className="login-btn">
                  {isSignUp != null ? (
                    <Dropdown as={ButtonGroup} title="Dropdown ">
                      <Dropdown.Toggle id="dropdown-custom-2" className="custom-dropdown">
                        {/* <i className="fas fa-user"></i> */}
                        <img src={accountPic} />
                      </Dropdown.Toggle>
            ...
            <div className="col-md-8 col-sm-8 col-8">
              <div className="bottom-right">
                ...
                <div className="contact-btn">
                  <a className="header-bottom-btn">
                    <img className="mr-2" src={callIcon} />

                    <span> 0198382-2928</span>
                  </a>
                </div>
         ...
         <div className="mobile-show">
          ...
          <div className="d-flex  mt-2 pr-2 justify-content-space-between">
               <ButtonLink  clicked={btnClickHandler}>
                ...
                <Search show={searchShow} className="flex-grow-1 mr-3 search-mobile search" closed={searchClose} />
