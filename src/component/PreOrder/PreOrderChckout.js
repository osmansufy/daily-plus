    ...
    {preProducts.length>0 && preProducts.map((item, index)=>(
            <div  className="cart-product mx-auto col-md-10">
                ...
                <div  className="quantity">
                  <h5 className="preOrderDate my-2">Pre-order ({ moment(item?.pre_order_details?.delivery_date).utc().format('MMM DD.YYYY')})</h5>
                ...
                <div  className="cart-price">
                  ...
                  <p  className="sell-price"><small>ট</small> {item.prod_inventory_list[0].unit_price_final}</p>
     ...
     <div className="address-icon mr-3">
                ...
                <div className="order-price-container">
                  ...
                  <p>Delivery Charge <span className="float-right">BDT 0</span></p>
                  <h6>Total <span className="float-right">BDT {preProducts.length>0? preProducts.map(cart=>cart.prod_inventory_list[0].unit_price_final*cart.item_count).reduce(reducer):0}</span></h6>
                </div>
